...
This guide will walk you through retrieving telemetry data from your device using the AutoPi REST API. You'll learn how to export data in two formats, aggregated data for high-level analysis and raw data for detailed insights. The guide covers endpoint parameters, query examples, and practical Python code to download and save your device data.

**Data export options:**
1. **Aggregated Data** — simplified, interval-based summaries (average, min, max) for easier analysis.
2. **Raw Data** — detailed, unprocessed data recorded by your device for deeper insights and customization.
