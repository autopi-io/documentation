# Installing a Camera on Your AutoPi
...
This guide will walk you through attaching an external USB camera to your AutoPi device and configuring it for video streaming and recording. You'll learn how to install and configure motion and MotionEye software, set up video recording and motion detection, access the camera feed through a web interface, and fine-tune camera settings for your environment.

**Prerequisites:**
- SSH access to your AutoPi device — see [How to SSH to Your Device](https://docs.autopi.io/developer_guides/how-to-ssh-to-your-device/).
- A USB web camera compatible with Linux.
- Basic familiarity with command-line SSH operations.

---

## Software Overview

This guide uses two key software components:
