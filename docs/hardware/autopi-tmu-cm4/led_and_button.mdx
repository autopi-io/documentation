...
![LED and Button location](/img/hardware/tmu_cm4/led_button_location.png)

The following state diagram explains this lifecycle. The LED is the Blue LED on the side of the device.

![LED and Button states](/img/hardware/tmu_cm4/led_button_states.png)
...
| Flashing rapidly | AutoPi Core software upgrade in progress |
