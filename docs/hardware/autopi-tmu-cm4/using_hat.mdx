...
|   16    |  RP2040_GPIO27      | Connection to RP2040 SPM on GPIO27       | 3.3V Level - [See RPI2040 datasheet  for details](https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf) |
|   17    |  5V_EXT      |   Controlable 5V supply     | Maximum current rating 500mA |
|   18    |  3V3_EXT      |   Controlable 3.3V supply     | Maximum current rating 500mA |
|   19    |  DOIP_ACT      |  Connection to RP2040 SPM on DoIP activate pin      | |
|   20    |  RPI_GPIO23      |  Raspberry Pi CM4 GPIO23      | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   21    |  RPI_GPIO24      |  Raspberry Pi CM4 GPIO24      | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   22    |  RPI_GPIO27      |  Raspberry Pi CM4 GPIO27      | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   23    |  GND      |    Ground    | |
|   24    |  GND      |  Ground      | |
|   25    |  5V      |  5V Supply     | Maximum current rating 500mA |
|   26    |  3V3      |  3.3V Supply      | Maximum current rating 500mA |
...
|   31    |  RPI_PWR      |   CM4 power status pin     | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   32    |  RP2040_GPIO17      |  Connection to RP2040 SPM on GPIO17      | 3.3V Level - [See RPI2040 datasheet  for details](https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf) |
|   33    |  RP2040_GPIO28      |  Connection to RP2040 SPM on GPIO28      | 3.3V Level - [See RPI2040 datasheet  for details](https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf) |
|   34    |  USB_DP_EXT      |  USB4 D+ Data line - HAT USB      | |
|   35    |  USB_DM_EXT      |  USB4 D- Data line - HAT USB        | |
|   36    |  RPI_GPIO22      |  Raspberry Pi CM4 GPIO22       | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   37    |  RPI_ID_SD      |  Raspberry Pi CM4 ID_SD       | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   38    |  RPI_ID_SC      |  Raspberry Pi CM4 ID_SC       | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   39    |  I2C1_SDA      |  I2C1 Data line      | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
|   40    |  I2C1_SCL      |  I2C1 Clock line      | 3.3V Level - [See CM4 datasheet  for details](https://datasheets.raspberrypi.com/cm4/cm4-datasheet.pdf) |
...
![HAT Example](/img/hardware/tmu_cm4/HAT_dimensions.jpg)
