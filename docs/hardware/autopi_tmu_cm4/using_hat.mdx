...
|:-----:|--------|--------|--------|
|   1   |    HS_CAN_HIGH / OBD_PIN_6    | Bi-directional |  Connection to CAN0 High line and directly to OBD pin     | | 
|   2    |   HS_CAN_LOW / OBD_PIN_14     | Bi-directional | Connection to CAN0 Low line and directly to OBD pin      | |
|   3    |   MS_CAN_HIGH / OBD_PIN_3     | Bi-directional | Connection to CAN1 High line and directly to OBD pin      | |
|   4    |   MS_CAN_LOW / OBD_PIN_11     | Bi-directional | Connection to CAN1 Low line and directly to OBD pin      | |
