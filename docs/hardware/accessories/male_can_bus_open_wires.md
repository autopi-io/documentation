---
id: male-can-bus-open-wires
title: Male CAN Bus Cable with Open Wires
...
:::info
This cable can be purchased through the AutoPi shop: [**Male CAN Bus Cable with Open Wires**](https://shop.autopi.io/products/can-bus-cable-w-open-wires).
:::
...
| Property            | Details                                           |
|:---------------------:|:---------------------------------------------------:|
| Connector Type      | Male CAN Bus connector                            |
