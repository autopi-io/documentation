...
* The External Antenna Kit (you can purchase one [here](https://shop.autopi.io/en/products/external-antenna-kit-18/))
* AutoPi TMU 3rd Gen
* A drill

**Step 2:** Disassemble the device by opening the four screws located on the backside.

![Unscrewed device](/img/hardware/autopi_dongle_gen3/installing_external_antennas/unscrewed_device.jpeg)

**Step 3:** Turn the device around and lift the **top part** while being careful not to damage the
antenna cable.

![Lift top part of AutoPi casing](/img/hardware/autopi_dongle_gen3/installing_external_antennas/lift_top_part_of_autopi_casing.jpeg)

**Step 4:** Remove the black antenna cable by pulling straight up, while being careful not to
damage the modem.

![Remove antenna cable](/img/hardware/autopi_dongle_gen3/installing_external_antennas/remove_antenna_cable.jpeg)
...
![Lifting device out of the enclosure](/img/hardware/autopi_dongle_gen3/installing_external_antennas/lifting_device_out_of_the_enclosure.jpeg)
...
![Drill locations](/img/hardware/autopi_dongle_gen3/installing_external_antennas/drill_locations.jpeg)
...
![SMA cable inserted](/img/hardware/autopi_dongle_gen3/installing_external_antennas/sma_cable_inserted.jpeg)
...
![SMA cable connected](/img/hardware/autopi_dongle_gen3/installing_external_antennas/sma_cable_connected.jpeg)

**Step 12:** The top lid of the enclosure will be mounted using the 4 black screws.

![Antenna ready device](/img/hardware/autopi_dongle_gen3/installing_external_antennas/antenna_ready_device.jpeg)
...
![Antennas connected to device](/img/hardware/autopi_dongle_gen3/installing_external_antennas/antennas_connected_to_device.jpeg)
