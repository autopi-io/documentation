...
This guide will require a medium level of DIY abilities/skills, and it will envolve drilling into
...
![Unscrewed device](/img/guides/installing_external_antennas/unscrewed_device.jpeg)

**Step 3:** Turn the device around and lift the **top part** while being careful not to damage the
antenna cable.

![Lift top part of AutoPi casing](/img/guides/installing_external_antennas/lift_top_part_of_autopi_casing.jpeg)

**Step 4:** Remove the black antenna cable by pulling straight up, while being careful not to
damage the modem.

![Remove antenna cable](/img/guides/installing_external_antennas/remove_antenna_cable.jpeg)
...
![Lifting device out of the enclosure](/img/guides/installing_external_antennas/lifting_device_out_of_the_enclosure.jpeg)
...
![Drill locations](/img/guides/installing_external_antennas/drill_locations.jpeg)
...
![SMA cable inserted](/img/guides/installing_external_antennas/sma_cable_inserted.jpeg)
...
![SMA cable connected](/img/guides/installing_external_antennas/sma_cable_connected.jpeg)

**Step 12:** The top lid of the enclosure will be mounted using the 4 black screws.

![Antenna ready device](/img/guides/installing_external_antennas/antenna_ready_device.jpeg)
...
![Antennas connected to device](/img/guides/installing_external_antennas/antennas_connected_to_device.jpeg)
