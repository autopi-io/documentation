...
![Service list](/img/guides/create_custom_workers/service_list.png) 
...
![Worker list](/img/guides/create_custom_workers/worker_list.png) 
...
![Create button](/img/guides/create_custom_workers/create_button.png) 

You'll be presented with the following window:

![Create empty worker](/img/guides/create_custom_workers/create_worker_empty.png) 
...
4. **Loop**: This is the amount of times the worker will execute within a power cycle of the AutoPi
  device. You can set this to the following values:
    ...
    2. *0 or more than 0*: The worker will loop the amount of times specified and then stop. This can be
...
![Create worker completed](/img/guides/create_custom_workers/create_worker_completed.png)
...
<Discussion
  ...
  url="https://community.autopi.io/t/guide-create-service-workers/2311"
/>