...
[trips](/cloud/trips/introduction), which are also viewable. The Cloud also keeps track of the
[events](/cloud/events/index.md) that were triggered on your device. In the events page, you are
