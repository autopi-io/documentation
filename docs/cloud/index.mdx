...
### Cloud API
The [API](/cloud/api/api-intro) gives you acccess to all the same functionalities you see in the cloud. Through the API it is possible to extend the features to your own systems or APP solution and thereby build on top of the platform. 
