...
![Community library overview](/img/cloud/obd_library/community_library/community_library_overview.png) 
...
See [this guide](/getting_started/developer_guides/autopi_logs.md) if you are unsure how to get the logs from the device.
