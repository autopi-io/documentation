...
fetching some data. We will navigate to the services page (Select device > Services) and select the
...
### Hooks
You can create your own custom hooks by creating a new custom module (Select device > Custom Code) with
