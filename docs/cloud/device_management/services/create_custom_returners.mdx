...
1. Start by creating a custom code module of type *Returner*. Go to **Select device** > **Custom Code**:
...
hook so it can be used in worker workflows. Go to **Select device** > **Services** > **acc_manager** >
**Hooks** > **Create**:
...
3. Next, we have to use the registered hook by editing the workflow for the **xyz_logger** worker.
  Go to **Select device** > **Services** > **acc_manager** > **Workers** > **xyz_logger**. Here we have
