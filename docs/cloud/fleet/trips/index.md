...
Trips are automatically detected based on the events sent from the device, by default the [engine events](../../device_management/events/vehicle.md#engine-events) are used. 

It is fully customizeable what events trigger a new trip to be created and it can be changed in the [advanced settings](../../device_management/advanced_settings/TMU/trip.md#event).
