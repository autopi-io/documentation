...
### Prerequisites
Before starting, complete the initial [setup guide](https://docs.autopi.io/getting_started/autopi_canfd_pro/).

---

### Check SIM Card

* Confirm that your SIM card is enabled for mobile datta. Test the SIM in another device (for example, a smartphone) and verify that internet access works.
...
* Verify that the SIM card is not PIN-locked. If it is PIN-locked, enter the correct PIN in the device settings.
