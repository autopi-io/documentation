...
This guide will explore how you can attach an external USB camera to your AutoPi device and make some use out of it.
...
take a look at [here](/getting_started/developer_guides/how-to-ssh-to-your-device/).
