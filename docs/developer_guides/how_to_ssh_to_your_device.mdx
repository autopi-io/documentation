...
## How-To
In this quick guide, we will explore how you can SSH into your [AutoPi](https://www.autopi.io) device.
...
### Execute Commands
All [AutoPi](https://www.autopi.io) native commands (commands normally run from the [Cloud](https://www.autopi.io/software-platform/cloud-management) terminal) can be run from the
