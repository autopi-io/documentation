...
This guide will walk you through accessing the community OBD library to discover supported PIDs for your vehicle. Learn how devices automatically report supported commands, how to find and add community PIDs to your personal library, how to create and share your own proprietary PIDs, and how to troubleshoot PID detection issues.

![Community library overview](/img/cloud/obd_library/community_library/updated_overview.png)

What you'll learn:
- How the device automatically detects and reports supported PIDs from your vehicle.
- How to access and browse the community library of shared PIDs.
- How to filter the community library by vehicle make, model, and year.
- How to add discovered PIDs to your personal library.
- How to create custom proprietary PIDs with proper formulas and configurations.
- How to share your PIDs with the community for others to discover and use.
- How to set up loggers to collect data using community and custom PIDs.
- How to troubleshoot PID detection and visibility issues.
...
![Creating a new logger](/img/cloud/obd_library/community_library/create_new_pid_logger.png)
